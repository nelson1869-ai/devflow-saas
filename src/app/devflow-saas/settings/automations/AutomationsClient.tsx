      ...
      <div className="space-y-8">
        ...
        <nav aria-label="Breadcrumb" className="text-xs text-slate-400">
          <ol className="flex items-center gap-1.5">
            ...
            <li>/</li>
            <li className="text-slate-400">Settings</li>
            <li>/</li>
          ...
          <div className="flex items-center gap-3">
            ...
            {isAdmin && (
              <button
                ...
                className="rounded-xl bg-cyan-400 px-4 py-2 text-xs font-semibold text-slate-950 hover:bg-cyan-300 transition shadow-sm focus-visible:outline-2 focus-visible:outline-cyan-400"
              >
                + Create Rule
              </button>
            )}
                      ...
                      <div className="flex items-center gap-2">
                        {isAdmin && (
                          <button
                            ...
                            disabled={isPending}
                            className={[
                              "relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus-visible:outline-2 focus-visible:outline-cyan-400",
                        ...
                        {isAdmin && (
                          <button
                            ...
                            title="Delete rule"
                            className="rounded p-1 text-slate-500 hover:bg-rose-500/20 hover:text-rose-300 transition focus-visible:outline-2 focus-visible:outline-rose-400"
                          >
                            ✕
                          </button>
                        )}
                  ...
                  {actionType === "add_tag" && (
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-lg border border-slate-700 bg-slate-950 px-2.5 py-1.5 text-xs text-slate-200 font-mono"
                      />
                    </div>
                  )}
